package com.hrdate.oj.aspect;

import com.alibaba.fastjson.JSON;
import com.hrdate.oj.annotation.OptLog;
...
public class OptLogAspect {
     ...
     */
    @Pointcut("@annotation(com.hrdate.oj.annotation.OptLog)")
    ...
    public void saveOptLog(JoinPoint joinPoint, Object keys) {
        ...
        // 请求用户ID
        operationLog.setUserId(TokenUtil.getLoginUser().getId());
        // 请求用户
        operationLog.setNickname(TokenUtil.getLoginUser().getNickname());
        // 请求IP
